...
const TVShowsPageSkeleton = (): React.JSX.Element => (
...
function TVShowsPage(): React.JSX.Element {
    ...
    async (pageNum: number) => {
      ...
      try {
        ...
        if (filters.genres.length > 0) {
          result = await tmdbApi.discoverTVShows({
            page: pageNum,
            genres: filters.genres,
            sortBy: ['on_the_air', 'airing_today'].includes(filters.sortBy)
              ? 'popularity.desc'
              : filters.sortBy
          })
        } else {
    ...
    <div className="page-container">
      <div className="catalog-section">
        ...
        {loading && items.length === 0 ? (
          ...
          <p className="empty-state">No TV shows found</p>
        ) : (
          <>
